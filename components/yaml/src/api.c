...
yaml_string_join(yaml_char_t **a_start, yaml_char_t **a_pointer, yaml_char_t **a_end, yaml_char_t **b_start,
                 yaml_char_t **b_pointer, SHIM(yaml_char_t **b_end))
{
    UNUSED_PARAM(b_end)
...
static int yaml_file_read_handler(void *data, unsigned char *buffer, size_t size, size_t *size_read)
{
    ...
    ret = f_read((FIL *)(parser->input.file), buffer, size, size_read);
    return FR_OK == ret ? 1 : 0;
#else
...
static int yaml_file_write_handler(void *data, unsigned char *buffer, size_t size)
{
    ...
    f_write((FIL *)emitter->output.file, buffer, size, &bw);
...
YAML_DECLARE(int)
yaml_document_start_event_initialize(yaml_event_t *event, yaml_version_directive_t *version_directive,
                                     ...
                                     int implicit)
{
    ...
    DOCUMENT_START_EVENT_INIT(*event, version_directive_copy, tag_directives_copy.start, tag_directives_copy.top, implicit,
                              mark, mark);
...
YAML_DECLARE(int)
yaml_scalar_event_initialize(yaml_event_t *event, const yaml_char_t *anchor, const yaml_char_t *tag, const yaml_char_t *value,
...
YAML_DECLARE(int)
yaml_sequence_start_event_initialize(yaml_event_t *event, const yaml_char_t *anchor, const yaml_char_t *tag, int implicit,
...
YAML_DECLARE(int)
yaml_mapping_start_event_initialize(yaml_event_t *event, const yaml_char_t *anchor, const yaml_char_t *tag, int implicit,
                         ...
                         int start_implicit, int end_implicit)
{
    ...
    DOCUMENT_INIT(*document, nodes.start, nodes.end, version_directive_copy, tag_directives_copy.start, tag_directives_copy.top,
...
YAML_DECLARE(int)
yaml_document_add_scalar(yaml_document_t *document, const yaml_char_t *tag, const yaml_char_t *value, int length,
