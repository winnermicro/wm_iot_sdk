/**
 * @file wm_drv_hspi_slave.c
 *
 * @brief HSPI Slave Driver Module
 *
 * This module implements the HSPI slave driver functionality for WinnerMicro devices.
