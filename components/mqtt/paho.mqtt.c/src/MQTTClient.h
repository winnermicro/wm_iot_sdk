...
LIBMQTT_API int MQTTClient_subscribe_wm(MQTTClient handle, const char* topic, int qos, int *msg_id);
...
LIBMQTT_API MQTTResponse MQTTClient_subscribe5_wm(MQTTClient handle, const char* topic, int qos,
...
LIBMQTT_API MQTTResponse MQTTClient_subscribeMany5_wm(MQTTClient handle, int count, char* const* topic,
...
LIBMQTT_API int MQTTClient_unsubscribe_wm(MQTTClient handle, const char* topic, int *msg_id);
...
LIBMQTT_API MQTTResponse MQTTClient_unsubscribe5_wm(MQTTClient handle, const char* topic, MQTTProperties* props, int *msg_id);
...
LIBMQTT_API MQTTResponse MQTTClient_unsubscribeMany5_wm(MQTTClient handle, int count, char* const* topic, MQTTProperties* props, int *msg_id);
