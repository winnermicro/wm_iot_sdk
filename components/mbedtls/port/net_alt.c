...
#ifdef CONFIG_COMPONENT_LWIP_ENABLED
...
#if CONFIG_LWIP_ENABLE_IPV4 && CONFIG_LWIP_ENABLE_IPV6
    struct sockaddr_in client_addr;
#elif CONFIG_LWIP_ENABLE_IPV6
...
#elif CONFIG_LWIP_ENABLE_IPV6
            ( bind_ctx->fd = (int) socket( local_addr.sin6_family,
#else
            ( bind_ctx->fd = (int) socket( local_addr.sin_family,
#endif
