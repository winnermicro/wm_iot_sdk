...
static const struct parse_data ssid_fields[] = {
	...
	{ INT_RANGE(fast_scan, 0, 1) },
	{ INT_RANGE(sort_type, 0, 1) },
	{ INT_RANGE(rssi_threshold, -255, 0) },
	{ INT_RANGE(auth_threshold, 0, 5) },
#endif
};
