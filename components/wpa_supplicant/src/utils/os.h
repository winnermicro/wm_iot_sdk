...
void *os_malloc_tracing(size_t size, const char *file, int line);
void *os_realloc_tracing(void *ptr, size_t size, const char *file, int line);
 ...
 */
#ifdef CONFIG_HEAP_USE_TRACING
#define os_zalloc(size) os_zalloc_tracing(size, __FILE__, __LINE__)
#else
...
#define os_calloc(nmemb, size) os_calloc_tracing(nmemb, size, __FILE__, __LINE__)
#else
 ...
 */
#ifdef CONFIG_HEAP_USE_TRACING
#define os_malloc(size) wm_os_internal_malloc_tracing(size, __FILE__, __LINE__)
#else
 ...
 */
#ifdef CONFIG_HEAP_USE_TRACING
#define os_realloc(ptr, size) wm_os_internal_realloc_tracing(ptr, size, __FILE__, __LINE__)
#else
