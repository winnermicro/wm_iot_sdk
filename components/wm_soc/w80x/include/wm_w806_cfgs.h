...
#ifndef __SOC_W806_CFGS_H__
#define __SOC_W806_CFGS_H__

/**
 * @defgroup WM_SOC_W806_CFG_TYPEs WM SOC Types
 * @brief WinnerMicro WM SOC Types
 */

/**
 * @addtogroup WM_SOC_W806_CFG_TYPEs
 * @{
 */
