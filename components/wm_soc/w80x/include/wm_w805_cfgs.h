...
#ifndef __SOC_W805_CFGS_H__
#define __SOC_W805_CFGS_H__

/**
 * @defgroup WM_SOC_W805_CFG_TYPEs WM SOC Types
 * @brief WinnerMicro WM SOC Types
 */

/**
 * @addtogroup WM_SOC_W805_CFG_TYPEs
 * @{
 */

typedef enum {
    WM_GPIO_NUM_START = 1,
    WM_GPIO_NUM_1     = WM_GPIO_NUM_START, /*PA1*/
    WM_GPIO_NUM_4     = 4,                 /*PA4*/
    WM_GPIO_NUM_7     = 7,                 /*PA7*/
