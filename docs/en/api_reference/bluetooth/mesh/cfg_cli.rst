...
specification. It provides functionality for configuring most parameters of 
mesh nodes, including encryption keys, model configurations and feature
activations.

The Configuration Client model communicates with the 
