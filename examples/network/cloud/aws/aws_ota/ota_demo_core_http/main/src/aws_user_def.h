...
#define AWS_OTA_TASK_STACK_SIZE      (8096) /** OTA task stack size */
#define AWS_OTA_TASK_PRIORITY        (4)    /** OTA task priority */
 ...
 */
#define AWS_IOT_ENDPOINT  "a2crv3ycvx4d9c-ats.iot.ap-northeast-2.amazonaws.com"
 ...
 */
#define CLIENT_IDENTIFIER "wm_demo_1"
