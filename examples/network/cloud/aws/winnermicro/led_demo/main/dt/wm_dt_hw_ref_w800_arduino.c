...
const static wm_dt_hw_pin_cfg_t dt_hw_pwm_pin[] = {
    [0] = { .pin_num = WM_GPIO_NUM_16, .pin_mux = WM_GPIO_IOMUX_FUN1 }, //Ardunio: PWM channel0(LED Green)
    [1] = { .pin_num = WM_GPIO_NUM_17, .pin_mux = WM_GPIO_IOMUX_FUN1 }, //Ardunio: PWM channel1(LED Red)
    [2] = { .pin_num = WM_GPIO_NUM_18, .pin_mux = WM_GPIO_IOMUX_FUN1 }, //Ardunio: PWM channel2(LED Blue)
};
...
WM_DT_TABLE_DEFINE(, (sizeof(dt_hw_table_entry) / sizeof(dt_hw_table_entry[0])),
                   (void *)&dt_hw_table_entry[0]); //cppcheck # [syntaxError]
