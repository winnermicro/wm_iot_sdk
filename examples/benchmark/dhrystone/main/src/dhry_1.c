...
/* Main and Proc_0 in the Ada version             */
{
    ...
    printf("        should be:   DHRYSTONE PROGRAM, SOME STRING\n");
    printf("Int_1_Loc:           %d\n", Int_1_Loc); //cppcheck # [uninitvar]
    printf("        should be:   %d\n", 5);
    printf("Int_2_Loc:           %d\n", Int_2_Loc);
    printf("        should be:   %d\n", 13);
    printf("Int_3_Loc:           %d\n", Int_3_Loc); //cppcheck # [uninitvar]
    printf("        should be:   %d\n", 7);
    printf("Enum_Loc:            %d\n", Enum_Loc); //cppcheck # [uninitvar]
    printf("        should be:   %d\n", 1);
    printf("Str_1_Loc:           %s\n", Str_1_Loc);
    ...
    if (User_Time < Too_Small_Time) {
        ...
        Microseconds          = (float)fUser_Time * Mic_secs_Per_Second / (float)Number_Of_Runs;
        ...
        printf("Score (DMIPS/MHz):                          %6.2f\n",
               Dhrystones_Per_Second / 1757 / wm_drv_rcc_get_config_clock(wm_dt_get_device_by_name("rcc"), WM_RCC_TYPE_CPU));
        printf("\n");
    }
}
    ...
    One_Fifty *Int_Par_Ref;
{
    ...
    do                        /* executed once */
        if (Ch_1_Glob == 'A') //cppcheck # [uninitvar]
        /* then, executed */
        {
            Int_Loc -= 1;
    ...
    while (Enum_Loc != Ident_1); /* true */ //cppcheck # [uninitvar]
} /* Proc_2 */
